...
export const CHARACTERS = [
  {
    ...
    theme: {
      ...
      ambientColor: 0x6633ff,
      ambientIntensity: 1.6,
      sunColor: 0xaaccff,
      sunIntensity: 2.4,
      fillColor: 0x4400aa,
      fillIntensity: 0.9,
      buildingPalette: [0x4477cc, 0x5588ff, 0x77aaee, 0xaabbff, 0x3355bb, 0x9966ff],
      buildingEmissive: 0x112255,
...

  {
    ...
    theme: {
      ...
      ambientColor: 0x00cc99,
      ambientIntensity: 1.4,
      sunColor: 0x00ffcc,
      sunIntensity: 2.0,
      fillColor: 0x005577,
      fillIntensity: 0.8,
      buildingPalette: [0x00aa88, 0x00ccaa, 0x33ddbb, 0x55ccaa, 0x009977, 0x44bbaa],
      buildingEmissive: 0x005544,
...

  {
    ...
    theme: {
      ...
      ambientColor: 0xcc3300,
      ambientIntensity: 1.5,
      sunColor: 0xff7700,
      sunIntensity: 2.8,
      fillColor: 0x882200,
      fillIntensity: 1.0,
      buildingPalette: [0x331100, 0x441500, 0x222222, 0x1a0800, 0x3d1000, 0x2a0800],
      buildingEmissive: 0x882200,
      buildingEmissiveIntensity: 1.6,
...

  {
    ...
    theme: {
      ...
      ambientColor: 0x55bb00,
      ambientIntensity: 1.4,
      sunColor: 0xccff00,
      sunIntensity: 2.2,
      fillColor: 0x664400,
      fillIntensity: 0.8,
      buildingPalette: [0x7722bb, 0x9933dd, 0x441188, 0x885500, 0x336600, 0x5522aa],
      buildingEmissive: 0x440088,
      buildingEmissiveIntensity: 1.0,
      buildingMetalness: 0.0,
...

  {
    ...
    theme: {
      ...
      ambientColor: 0xdd7700,
      ambientIntensity: 1.5,
      sunColor: 0xffaa33,
      sunIntensity: 2.5,
      fillColor: 0x882200,
      fillIntensity: 0.7,
      buildingPalette: [0xcc9966, 0xbbaa77, 0xddaa88, 0xeecc99, 0xaa8855, 0xffbb77],
      buildingEmissive: 0x441500,
